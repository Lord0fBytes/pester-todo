...
The app displays both together, such as `0.6.1-0045`. The displayed value comes from the built app bundle, so it identifies what is actually installed on the phone.
